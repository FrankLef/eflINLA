...
test_that("transform_marginal_hyper", {
  ...
  marg <- transform_marginal_hyper(i04M07ctr, sd_name = "sd")
...
test_that("posterior_marginals: out_df = FALSE", {

  marg <- posterior_marginals(i04M07ctr, out_df = FALSE)
  # cat("\n", str(marg), "\n")
...
test_that("posterior_marginals: out_df = TRUE", {

  marg <- posterior_marginals(i04M07ctr, out_df = TRUE)
  # cat("\n")
  # str(marg)
  # cat("\n")
